...
export default function HomePage() {
  const aboutItems = [
    ...
    {
      icon: CreditCard,
      title: 'អត្រាការប្រាក់កម្ជី',
      description: 'ដាក់ពាក្យសុំកម្ជីជាសមាជិកដោយយុត្តិធម៌ មានអត្រាការប្រាក់តម្លាភាព ការផ្ទៀងផ្ទាត់អ្នកធានា និង ការទទួលយកពីគណៈកម្មាធិការ។',
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal animation="fade-up" className="max-w-2xl mb-12">
            ...
            <p className="text-gray-600 mt-4 leading-7">
              ស្វែងយល់អំពីបេសកកម្ម ជម្រើសចូលជាសមាជិក អត្ថប្រយោជន៍សន្សំ អត្រាការប្រាក់កម្ជី និង
              ...
              {aboutItems.map((item, index) => {
                ...
                return (
                  <ScrollReveal key={item.title} animation="fade-up" delay={index * 90}>
                    <div className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:border-blue-200 hover:shadow-lg transition-all h-full">
      ...
      <section className="min-h-screen flex items-center py-16 md:py-20 bg-slate-50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
            ...
            <ScrollReveal animation="fade-left" delay={120} className="rounded-3xl bg-blue-900 p-8 text-white shadow-xl shadow-blue-900/10 h-full">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { label: 'អត្រាការប្រាក់កម្ជី', value: 'ចាប់ពី ១-២% ក្នុងមួយខែ' },
