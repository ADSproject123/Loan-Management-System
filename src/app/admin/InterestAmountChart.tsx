...
import type { MonthlyInterestChartPoint } from '@/lib/admin/interestChartData'
...
export function InterestAmountChart({
  data,
  barColor,
  emptyMessage,
  rangeEmptyMessage,
}: {
  data: MonthlyInterestChartPoint[]
  barColor: string
  emptyMessage: string
  rangeEmptyMessage: string
}) {
