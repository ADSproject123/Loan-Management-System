...
import type { MonthlyLoanChartPoint } from '@/lib/admin/loanChartData'
...
export function LoanAmountChart({ data }: { data: MonthlyLoanChartPoint[] }) {
  ...
  if (isEmpty) {
    return (
      <p className="py-12 text-center text-sm text-slate-500">
        មិនទាន់មានកម្ជីសម្រាប់បង្ហាញក្រាប់។
      </p>
    )
  }
    ...
    <div>
      ...
      {!hasData ? (
        <p className="flex h-[65vh] min-h-80 items-center justify-center text-sm text-slate-500">
          មិនមានកម្ជី USD ក្នុង ១២ ខែចុងក្រោយ
        </p>
      ) : (
