              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <h2 className="mt-1 text-2xl font-bold text-gray-950">
                    {isPending ? 'ការចុះឈ្មោះកំពុងរង់ចាំការទទួលយក' : 'គណនីមិនទាន់ដំណើរការ'}
                  </h2>
                </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  { icon: ShieldCheck, title: 'ការទទួលយកសមាជិក', text: 'គណនីរបស់អ្នកនឹងដំណើរការបន្ទាប់ពីការត្រួតពិនិត្យ។' },
                  { icon: CheckCircle, title: 'ការចូលផ្ទាំងគ្រប់គ្រង', text: 'ឧបករណ៍សន្សំ និង ឥណទាននឹងបើកបន្ទាប់ពីការទទួលយក។' },
                ].map((item) => {
              ...
              <div className="mt-8 rounded-2xl border border-blue-100 bg-blue-50/80 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-blue-800">
                  រង់ចាំការទទួលយកពីអ្នកគ្រប់គ្រង។ ប្រសិនបើការចុះឈ្មោះរបស់អ្នកមានភាពបន្ទាន់ ឬ កំពុងរង់ចាំយូរពេក សូមទាក់ទងអ្នកគ្រប់គ្រងសន្សំ និង បញ្ជាក់ថាឯកសារដែលបានដាក់ស្នើច្បាស់។
                </p>
              </div>
